...
#End Region
    ...
    Protected Sub GenPDF(ByVal ProductID As Long)
        ...
        Dim books = XDocument.Load(webFolder & System.Configuration.ConfigurationManager.AppSettings("XML_AccessoriesFile"))
        ...
        If LetterRecord.Count = 1 Then
            ...
            Dim txtPageType As String = tdsLangInfo.accPageType
            ...
            Dim DestPDF = Server.MapPath("/pdfs/tds_accessory_" & bGuid.ToString & ".pdf")
            ...
            Try
                ...
                ' Manufacturer
                WriteHeadedParagraph(doc, ct, column, tdsLangInfo.accManufacturerHeader, AttrHdrFont, tdsLangInfo.accManufacturer, AttrFont, True)

                ' warranty area
                Dim warrHdrPara As Paragraph = New Paragraph
                warrHdrPara.SetLeading(leadingHdrF, leadingHdrM)
                Dim warrHdrChunk As Chunk = New Chunk(tdsLangInfo.accWarrantyHeader, AttrHdrFont)
                ...
                Dim warrChunk As Chunk = New Chunk(tdsLangInfo.accWarranty1, NoteFont)
